    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-10">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-3xl font-black text-yellow-400 uppercase tracking-widest drop-shadow-lg hidden md:block">
            ...
            <div class="lg:col-span-2 flex flex-col gap-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-gray-900">
                    ...
                    <div class="bg-white p-4 rounded-2xl shadow-sm text-center transform hover:scale-105 transition">
                        ...
                        <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Précision</p>
                    </div>
                </div>
                ...
                <div class="bg-white text-gray-900 p-6 md:p-8 rounded-3xl shadow-xl">
                    <h3 class="font-black text-indigo-900 mb-6 uppercase tracking-widest border-b-2 border-indigo-100 pb-2">🎯 Progression des Quêtes</h3>
